...
(function () {
  ...
  var STRINGS = {
    tr: {
      ...
      reviews_page_lead:
        "Görselleri büyütebilir, oklar veya kaydırma ile aralarında gezebilirsiniz.",
    ...
    en: {
      ...
      reviews_carousel_label: "Client testimonial screenshots",
      reviews_prev: "Previous testimonials",
      reviews_next: "Next testimonials",
      review_alt: "Client testimonial image",
      view_all_reviews: "View all testimonials",
      reviews_page_h1: "Client feedback",
      reviews_page_lead:
        "Tap for fullscreen, use arrows or swipe between screenshots.",
      ...
      meta_reviews_desc:
        "Client testimonials and screenshots — Erol Erdoğar, TURYAP ATAŞEHİR İMZA real estate consultant.",
